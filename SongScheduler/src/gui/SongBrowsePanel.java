...
/*
 * SongBrowsePanel.java
 *
 * Created on Jul 8, 2009, 4:16:29 PM
 */
 ...
 * @author jordan
 */
public class SongBrowsePanel extends javax.swing.JFrame {

    private ArrayList songs;
    private DefaultListModel listModel;


    /** Creates new form SongBrowsePanel */
    public SongBrowsePanel() {
        Song currSong;
        ...
        selectedSongInfoPanelLayout.setHorizontalGroup(
            ...
            .add(selectedSongInfoPanelLayout.createSequentialGroup()
                ...
                .add(selectedSongInfoPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(songYearDisplay, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    ...
                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(layout.createSequentialGroup()
                            ...
                            .add(songNameLabel)
                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            .add(songNameText, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE))
    ...
    public Song getSelectedSong(){
        return (Song) songs.get( songList.getSelectedIndex() );
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SongBrowsePanel().setVisible(true);
            }
        });
    }
